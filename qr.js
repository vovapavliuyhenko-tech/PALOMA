...
(function () {
  ...
  function applyFormat(grid, maskIndex) {
    ...
    for (var i = 0; i < 15; i++) {
      ...
      /* Вторая копия: биты 0–6 идут вверх по столбцу, биты 7–14 — по
         строке 8 справа. Раньше здесь стояло i < 8, и бит 7 попадал на
         место тёмного модуля, который его тут же затирал. */
